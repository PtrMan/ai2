...
namespace ProgramRepresentation.Execution
{
    ...
    //
    sealed class FunctionalInterpreter
    {
        public enum EnumInvokeDispatcherCallResult
        {
            DONE,
        ...
        {
            void dispatchInvokeStart(List<string> path, List<Datastructures.Variadic> parameters, List<InterpretationState.ScopeLevel> calleeScopeLevels, out Datastructures.Variadic result, out EnumInvokeDispatcherCallResult callResult);
        ...
        public sealed class InterpretationState
        {
            public sealed class ScopeLevel
            {
                ...
                {
                    public string name;
                    public Datastructures.Variadic value;
                }
                ...
                public List<Datastructures.Variadic> foldInputArray; /** \brief array with the values for folding, can be calculated or can point at an array inside a variadic */
                ...
                public List<Datastructures.Variadic> foreachArray; /** \brief array for iteration */
                public List<Datastructures.Variadic> foreachResultArray;
                public int foreachIndexInArray = 0;

                public EnumPassState passState = EnumPassState.INITIAL;

                public int arrayIndex = 0;
                public List<Datastructures.Variadic> arrayResultArray;
                ...
                public List<Datastructures.Variadic> invokeResolvedParameters;

                public EnumSetVariablesState setVariablesState = EnumSetVariablesState.INITIAL;
                public int setVariablesVariableIndex = 0;
            }

            public sealed class InvokableProgram
            {
                public List<string> path = new List<string>();
                public int dagIndex = -1;

                // variables are set with the parameters of the invoke
                public List<string> variableNames = new List<string>(); /** \brief names of the variables for the invoke call */
            }

            public List<ScopeLevel> scopeLevels = new List<ScopeLevel>();
            ...
            // TODO< dict? >
            public List<InvokableProgram> invokablePrograms = new List<InvokableProgram>();
        }
        ...
        // helper method
        private static bool isStringArrayTheSame(List<string> a, List<string> b)
        {
            int i;
